                ...
                <div className='about-me__student-info'>
                    <div className='about-me__student-info1'>
                        ...
                        <div className='about-me__student-links'>
                            <a href='https://www.facebook.com/' className='about-me__student-link'>Facebook</a>
                            <a href='https://github.com/Amidamaru2199?tab=repositories' className='about-me__student-link'>Github</a>
                        </div>
                    </div>
